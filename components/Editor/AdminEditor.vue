  ...
  <div>
    <div v-if="editor" class="space-x-2 pt-1 pb-2">
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('bold') }"
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('italic') }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('code') }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('heading', { level: 1 }) }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('heading', { level: 2 }) }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('heading', { level: 3 }) }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('heading', { level: 4 }) }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('heading', { level: 5 }) }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('heading', { level: 6 }) }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('bulletList') }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('orderedList') }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
      ...
      <button type="button"
        ...
        :class="{ 'is-active bg-slate-100 dark:bg-slate-400': editor.isActive('codeBlock') }"
        class="w-6 py-1 px-1 active:ring-1 rounded-sm focus:ring-primary-500 "
      >
