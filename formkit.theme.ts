...
/**
  ...
  *
  * @checksum - 8bf5e163690659c02dec612ea6e128910486e16da2f178c743230dd830108d46
  * @variables - radius=rounded,accentColor=indigo,colorTemperature=stone,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "rating__ratingItem": {
    ...
    "focus-within:outline-indigo-600": true,
    "w-[1.5em]": true,
    "h-[1.5em]": true
  },
